...
const Register = () => {
    const [fields, setFields] = useState({
        firstName: '', lastName: '', email: '', address: '', phoneNumber: '', password: '', confirmPassword: '',
    });
    ...
    const validateField = (name, value) => {
        ...
        switch (name) {
            ...
            case 'address':
                ...
                break;
            case 'phoneNumber':
                if (value && !/^\d{10}$/.test(value)) error = 'Invalid phone number format. Must be 10 digits.';
                break;
            case 'password':
                if (value) {
            ...
            case 'confirmPassword':
                if (value && value !== fields.password) error = 'Passwords do not match.';
                break;
            default:
                break;
        }
